...
export const nonAlphaDepositFilters: TransactionFilter[] = (function () {
    ...
    const alphafi_cetus_sui_pool_2filters = conf[CONF_ENV].ALPHA_2_PACKAGE_IDS.map(
      (id) => {
        return {
          MoveFunction: {
            function: "user_deposit",
    ...
    const alphafi_cetus_pool_base_a_1filters = conf[CONF_ENV].ALPHA_PACKAGE_IDS.map(
      (id) => {
        return {
          MoveFunction: {
            function: "user_deposit",
    ...
    const alphafi_cetus_pool_base_a_2filters = conf[CONF_ENV].ALPHA_2_PACKAGE_IDS.map(
      (id) => {
        return {
          MoveFunction: {
            function: "user_deposit",
  ...
  export const alphaDepositFilters: TransactionFilter[] = (function () {
    const alpha1filters = conf[CONF_ENV].ALPHA_PACKAGE_IDS.map(
      (id) => {
        return {
          MoveFunction: {
            function: "user_deposit",
    ...
    const alpha2fliters = conf[CONF_ENV].ALPHA_2_PACKAGE_IDS.map(
      (id) => {
        return {
          MoveFunction: {
            function: "user_deposit",
