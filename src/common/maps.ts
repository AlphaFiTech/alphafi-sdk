...
export const poolInfo: {
  ...
  "BLUEFIN-NAVX-VSUI": {
    ...
    // add strategy type
    imageUrl1: "", // add NAVX image here
    imageUrl2: "", // add VSUI image here
  },
  "BLUEFIN-SUI-AUSD": {
    packageId: conf[CONF_ENV].ALPHA_4_LATEST_PACKAGE_ID,
    packageNumber: 4,
