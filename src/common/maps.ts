...
export const bluefinPoolMap: { [key: string]: string } = {
  ...
  "STSUI-SUI-ZERO-ZERO": conf[CONF_ENV].BLUEFIN_STSUI_SUI_ZERO_ZERO_POOL,
...
export const poolInfo: {
  ...
  "BLUEFIN-LYF-SUIUSDT-USDC": {
    ...
    receiptName: conf[CONF_ENV].ALPHAFI_LYF_SUIUSDT_USDC_RECEIPT_NAME,
    receiptType: conf[CONF_ENV].ALPHAFI_LYF_SUIUSDT_USDC_RECEIPT,
    assetTypes: [coinsList["SUIUSDT"].type, coinsList["USDC"].type],
    autoCompoundingEventType:
      conf[CONF_ENV].ALPHAFI_LYF_SUIUSDT_USDC_AUTO_COMPOUNDING_EVENT,
    rebalanceEventType:
      conf[CONF_ENV].ALPHAFI_LYF_SUIUSDT_USDC_POOL_REBALANCE_EVENT,
  ...
  "ALPHALEND-SINGLE-LOOP-WBTC": {
    ...
    parentPoolId: conf[CONF_ENV].ALPHAFI_ALPHALEND_SINGLE_LOOP_WBTC_POOL, //NO PARENT POOL
    ...
    receiptName: conf[CONF_ENV].ALPHAFI_ALPHALEND_SINGLE_LOOP_WBTC_RECEIPT_NAME,
    receiptType: conf[CONF_ENV].ALPHAFI_ALPHALEND_SINGLE_LOOP_WBTC_RECEIPT,
  ...
  "ALPHALEND-SINGLE-LOOP-DEEP": {
    ...
    packageNumber: 10,
    parentProtocolName: "ALPHALEND",
    parentPoolId: conf[CONF_ENV].ALPHAFI_ALPHALEND_SINGLE_LOOP_DEEP_POOL, //NO PARENT POOL
    ...
    receiptName: conf[CONF_ENV].ALPHAFI_ALPHALEND_SINGLE_LOOP_DEEP_RECEIPT_NAME,
    receiptType: conf[CONF_ENV].ALPHAFI_ALPHALEND_SINGLE_LOOP_DEEP_RECEIPT,
  ...
  "ALPHALEND-SINGLE-LOOP-WAL": {
    ...
    packageNumber: 10,
    parentProtocolName: "ALPHALEND",
    parentPoolId: conf[CONF_ENV].ALPHAFI_ALPHALEND_SINGLE_LOOP_WAL_POOL, //NO PARENT POOL
    ...
    receiptName: conf[CONF_ENV].ALPHAFI_ALPHALEND_SINGLE_LOOP_WAL_RECEIPT_NAME,
    receiptType: conf[CONF_ENV].ALPHAFI_ALPHALEND_SINGLE_LOOP_WAL_RECEIPT,
  ...
  "ALPHALEND-LOOP-SUI-STSUI": {
    ...
    receiptName: conf[CONF_ENV].ALPHALEND_SUI_STSUI_LOOP_RECEIPT_NAME,
    receiptType: conf[CONF_ENV].ALPHALEND_LOOP_SUI_STSUI_RECEIPT,
    ...
    checkRatioEventType:
      conf[CONF_ENV].ALPHALEND_LOOP_SUI_STSUI_POOL_CHECK_RATIO_EVENT,
    imageUrl1: "https://images.alphafi.xyz/adminweb/sui-logo1.svg",
